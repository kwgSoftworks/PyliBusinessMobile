...
class AdjustmentListView extends HookWidget {
  @override
  Widget build(BuildContext context) {
    return CustomScaffold(
      header_title: "Adjustment",
                          ...
                          children: [
                            Expanded(
                              child: CustomButton(
                                ...
                                onTap: (){
                                  locator<NavigationHandler>().pushNamed(Routes.create_adjustment_view);
                                },
                              ),
                            ),
                            Gap(10.0.w),
