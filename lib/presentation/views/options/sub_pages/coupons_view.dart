...
import 'package:pyli_business_mobile/presentation/views/options/components/adjustment_table_item_widget.dart';
import 'package:pyli_business_mobile/presentation/views/options/components/coupons_table_item_widget.dart';
import 'package:pyli_business_mobile/utils/__utils.dart';
import 'package:pyli_business_mobile/utils/enums.dart';

class CouponsView extends HookWidget {
  @override
  Widget build(BuildContext context) {
    return CustomScaffold(
      header_title: "Coupons",
                          ...
                          children: [
                            Expanded(
                              child: CustomButton(
                                ...
                                onTap: (){
                                  locator<NavigationHandler>().pushNamed(Routes.create_coupons_view);
                                },
                              ),
                            ),
                            Gap(10.0.w),
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomButton(
                                ...
                                borderRadius: 5.0,
                                title: "All Coupons",
                                titleColor: CustomColors.appBlackColor2,
                                titleBold: true,
