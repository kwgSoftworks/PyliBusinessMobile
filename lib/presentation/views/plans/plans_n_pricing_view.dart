...
import 'package:pyli_business_mobile/presentation/views/plans/components/grouped_plan_widget.dart';
...
class PlansNPricingView extends HookWidget {
  @override
  Widget build(BuildContext context) {
    return CustomScaffold(
      header_title: "Plans & Pricing",
                ...
                CustomButton(
                  ...
                  onTap: () {
                    locator<NavigationHandler>().pushNamed(
                      Routes.create_plans_view,);
                  },
                ),
                Gap(20.h),
                GroupedPlanWidget(
                  group_title: "Residential Plans",
                  allSinglePlans: [
                    SinglePlanWidget(
                      isFeatured: true,
                    ),
